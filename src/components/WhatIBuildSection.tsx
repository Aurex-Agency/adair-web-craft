...
const WhatIBuildSection = () => {
  return (
    <section id="services" className="bg-[#0D0D0D] py-[72px] md:py-32 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <AnimateIn delay={0}>
            <div className="bg-bg-surface border border-border-custom rounded-2xl p-10 h-full">
              <span className="inline-block bg-[#1A2E1A] text-accent-green font-inter text-xs font-semibold px-3 py-1.5 rounded-full mb-8">
              ...
              <ul className="space-y-4">
                {included.map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <span className="font-inter text-[15px] text-text-primary">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <AnimateIn delay={0.1}>
            <div className="bg-bg-surface border border-border-custom rounded-2xl p-10 h-full">
              <span className="inline-block bg-[#1A1A2E] text-accent-blue font-inter text-xs font-semibold px-3 py-1.5 rounded-full mb-8">
                Add-Ons Available
              </span>
              <ul className="space-y-4">
                {addOns.map((item, i) => (
        ...
        <AnimateIn delay={0.2}>
          <div className="rounded-2xl p-[1px] bg-gradient-to-br from-accent-blue to-accent-green">
            <div className="bg-bg-surface rounded-2xl p-12 text-center">
              <p className="font-inter text-sm text-text-muted mb-2">Websites starting at</p>
              <p className="font-syne font-extrabold text-[72px] text-text-primary leading-none mb-2">$500</p>
              <p className="font-inter text-base text-text-muted mb-8">with a plan that fits your budget</p>
              <a
                href="#contact"
